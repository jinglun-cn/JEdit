...
import org.gjt.sp.jedit.search.HyperSearchStyleEditor;
...
public class HyperSearchResults extends JPanel implements DefaultFocusComponent
{
	...
	public class ActionHandler implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent evt)
		{
			...
			if(source == highlight)
			{
				...
				Font f = (resultTree != null) ? resultTree.getFont() :
					UIManager.getFont("Tree.font");
				SyntaxStyle style = new HyperSearchStyleEditor(jEdit.getActiveView(),
	...
	class HighlightingTree extends JTree
	{
				...
				boolean expanded, boolean leaf, int row, boolean hasFocus)
		{
			...
			String newPropfgColor = "";
            if (newProp.length()> 16){  //when newProp contains fgColor
				newPropfgColor = newProp.substring(0, 14);
			}
			if (commentLine)
				newProp = newPropfgColor+"bgColor:#008000"; //green
			else
				newProp = newPropfgColor+"bgColor:#FF0000"; //red
