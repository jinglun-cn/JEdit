...
/** Style editor dialog */
public class HyperSearchStyleEditor extends EnhancedDialog implements ActionListener
{
	...
	public static void invokeForCaret(JEditTextArea textArea)
	{
		...
		SyntaxStyle style = new HyperSearchStyleEditor(textArea.getView(),
	...
	public HyperSearchStyleEditor(JDialog parent, SyntaxStyle style, String styleName)
	{
		super(parent, jEdit.getProperty("style-editor.title"),true);
		initialize(parent, style, styleName);
	}
	public HyperSearchStyleEditor(JFrame parent, SyntaxStyle style, String styleName)
	{
		super(parent, jEdit.getProperty("style-editor.title"),true);
		initialize(parent, style, styleName);
	}
